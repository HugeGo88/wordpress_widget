...
part 'src/pages/events_tab.dart';
...
part 'src/pages/detail_elements/event_detail_data.dart';
part 'src/pages/event_detail.dart';
...
part 'src/widgets/event_list.dart';
part 'src/widgets/event_list_item.dart';
...
part 'src/models/event_entity.dart';
part 'src/models/ticket_entitiy.dart';
